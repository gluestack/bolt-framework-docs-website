...
<Meta pageTitle="Property Resolver | gluestack-style" description="gluestack-style allows you to modify the resolution of value of any style property that you pass by providing a callback function against any style property." />

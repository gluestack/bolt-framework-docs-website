...
<Meta pageTitle="Responsive Styles | gluestack-style" description="gluestack-style supports responsive styles using media queries. You can define your breakpoints and other configuration options." canonical="https://style.gluestack.io/" />
...
import { config } from '@/docs-components/seal-framework-docs-storybook/api/ResponsiveStyles/config';

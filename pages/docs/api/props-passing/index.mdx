...
<Meta pageTitle="Props Passing | gluestack-style" description="gluestack-style allows you to pass properties to your styled component directly from the style configuration, also known as the component theme." />

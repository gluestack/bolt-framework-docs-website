...
<Meta pageTitle="Utility Props | gluestack-style" description="Writing inline styles with Utlity Props. We provide you the ability to pass down utility props on any Styled Component which internally converts to `sx` prop." />

...
<Meta pageTitle="Descendant Styling | gluestack-style" description="A guide on how to style the descendants of a component. With this, you can define styles that are passed down to children." />
...
import { config } from '@/docs-components/seal-framework-docs-storybook/api/DescendantsStyles/config';

...
<Meta pageTitle="Utility Functions | gluestack-style" description="Create global CSS styles easily with createGlobalStylesWeb function, supporting aliases and tokens for easy integration. Only for web, with some limitations." canonical="https://style.gluestack.io/" />

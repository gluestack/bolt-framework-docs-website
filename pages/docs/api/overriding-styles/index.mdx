...
<Meta pageTitle="Overriding styles with sx | gluestack-style" description="The sx prop allows you to pass an object that supports tokens, media-queries, nesting and token-aware values to the component." />

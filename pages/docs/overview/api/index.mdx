...
<Meta pageTitle="API | API's in gluestack-style" description="A brief about all the API that you get from gluestack-style. With our styled function, you can easily extend existing components and make them customizable and themeable." />
...
gluestack-style Style exports a StyledProvider component that can be used to configure your components. This is useful when you want to define some aliases, tokens, propertyTokenMap, and propertyResolver at a global level throughout your app. You can define them in `gluestack-style.config.js` file and pass it to the StyledProvider.

...
<Meta pageTitle="Performance | gluestack-style" description="Know about how performant is gluestack-style. It uses a babel plugin for pre-computing styles during the build process, and runtime performance optimizations." />

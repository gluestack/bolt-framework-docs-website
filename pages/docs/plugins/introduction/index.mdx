...
<Meta pageTitle="Intro to Plugins | gluestack-style" description="gluestack-style provides a plugin system to extend existing functionality of styled function. It's a great way to add support for new aliases, tokens and beyond." canonical="https://style.gluestack.io/" />

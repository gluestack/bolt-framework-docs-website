...
<Meta pageTitle="Animation Plugin | gluestack-style" description="Learn to add animation props with gluestack-style’s Animation Plugin for dynamic, animated UI elements. Performance impacts and lack of typings are limitations." canonical="https://style.gluestack.io/" />

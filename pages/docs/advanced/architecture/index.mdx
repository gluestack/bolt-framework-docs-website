...
<Meta pageTitle="Architecture | gluestack-style" description="The architecture of gluestack-style is based on the concept of styled components, which enhances existing components to make them customizable and themeable." />

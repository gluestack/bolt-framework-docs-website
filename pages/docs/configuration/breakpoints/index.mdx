...
<Meta pageTitle="Breakpoints | gluestack-style" description="How to create and use breakpoints in gluestack-style. You can define your breakpoints in `gluestack-style.config.js`. Breakpoints are defined in `mediaQueries` scale." />

...
<Meta pageTitle="StyledProvider | gluestack-style" description="gluestack-style Style exports a StyledProvider component, a higher-order component that wraps your entire application and provides the library's configuration options." />

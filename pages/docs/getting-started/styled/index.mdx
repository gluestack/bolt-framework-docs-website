...
<Meta pageTitle="styled - Extend existing components | gluestack-style" description="With styled, you can easily extend existing components and make them customizable and themeable. gluestack-style has provided styled function for this." />
